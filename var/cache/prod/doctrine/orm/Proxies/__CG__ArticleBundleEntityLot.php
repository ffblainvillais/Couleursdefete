 ...
 */
class Lot extends \ArticleBundle\Entity\Lot implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ArticleBundle\\Entity\\Lot' . "\0" . 'id', '' . "\0" . 'ArticleBundle\\Entity\\Lot' . "\0" . 'libelle', '' . "\0" . 'ArticleBundle\\Entity\\Lot' . "\0" . 'prix'];
        }
