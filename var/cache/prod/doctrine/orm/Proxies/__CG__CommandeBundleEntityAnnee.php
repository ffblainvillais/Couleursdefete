 ...
 */
class Annee extends \CommandeBundle\Entity\Annee implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'CommandeBundle\\Entity\\Annee' . "\0" . 'id', '' . "\0" . 'CommandeBundle\\Entity\\Annee' . "\0" . 'libelle'];
        }
