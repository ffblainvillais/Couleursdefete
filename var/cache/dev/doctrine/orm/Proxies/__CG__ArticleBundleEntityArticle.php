...
class Article extends \ArticleBundle\Entity\Article implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ArticleBundle\\Entity\\Article' . "\0" . 'id', '' . "\0" . 'ArticleBundle\\Entity\\Article' . "\0" . 'libelle', '' . "\0" . 'ArticleBundle\\Entity\\Article' . "\0" . 'quantite', '' . "\0" . 'ArticleBundle\\Entity\\Article' . "\0" . 'description', '' . "\0" . 'ArticleBundle\\Entity\\Article' . "\0" . 'prix', '' . "\0" . 'ArticleBundle\\Entity\\Article' . "\0" . 'utilisateur'];
        }
    ...
    public function nomDescription()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'nomDescription', []);

        return parent::nomDescription();
    }
