 ...
 */
class Client extends \ClientBundle\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ClientBundle\\Entity\\Client' . "\0" . 'id', '' . "\0" . 'ClientBundle\\Entity\\Client' . "\0" . 'nom', '' . "\0" . 'ClientBundle\\Entity\\Client' . "\0" . 'prenom', '' . "\0" . 'ClientBundle\\Entity\\Client' . "\0" . 'adresse', '' . "\0" . 'ClientBundle\\Entity\\Client' . "\0" . 'mail', '' . "\0" . 'ClientBundle\\Entity\\Client' . "\0" . 'utilisateur'];
        }
